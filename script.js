...
const tiles = [
  ...
  { photo: 'p40', label: 'Mont Tremblant', sub: 'Take me back 🏔️', bg: '#FFD600' },
  ...
  { photo: 'p21', label: 'Vittoria Trattoria', sub: 'The Italian Dinner', bg: '#AAEE44' },
  { photo: 'p22', label: 'The bachelorette vibes', sub: 'Jhoola Jhoola', bg: '#FFD600' },
