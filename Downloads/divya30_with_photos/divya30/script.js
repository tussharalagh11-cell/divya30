...
const tiles = [
  { photo:'photos/p15.jpg', label:'Baby Divya',        sub:'Where it all began 🌸',      bg:'#FF3CAC' },
  { photo:'photos/p01.jpg', label:'The GUESS era',      sub:'Pink was always right',      bg:'#FFD600' },
  { photo:'photos/p06.jpg', label:'The lehenga',        sub:'She wore it like a queen',   bg:'#AAEE44' },
  { photo:'photos/p04.jpg', label:'Dressed up',         sub:'Effortlessly stunning',      bg:'#FF5C1A' },
  { photo:'photos/p05.jpg', label:'Holi',               sub:'Colour on colour on colour', bg:'#00C9B1' },
  { photo:'photos/p16.jpg', label:'That orange lehenga',sub:'She showed up',              bg:'#FF3CAC' },
  { photo:'photos/p02.jpg', label:'Navratri',           sub:'Day 2 — White ♡',           bg:'#3B6EF8' },
  { photo:'photos/p03.jpg', label:'Saturday 2:37 PM',   sub:'A perfect ordinary day',    bg:'#FFD600' },
  { photo:'photos/p17.jpg', label:'Somewhere in Europe',sub:'Pizza & adventure',          bg:'#FF5C1A' },
  { photo:'photos/p20.jpg', label:'The best smile',     sub:'That laugh though',          bg:'#AAEE44' },
  { photo:'photos/p07.jpg', label:'FaceTime',           sub:'Cheek on hand, always',      bg:'#FF3CAC' },
  { photo:'photos/p08.jpg', label:'Laughing',           sub:'The real ones',              bg:'#FFD600' },
  { photo:'photos/p09.jpg', label:'That smile',         sub:'Gets me every time',         bg:'#00C9B1' },
  { photo:'photos/p10.jpg', label:'Laughing hard',      sub:'Uncontrollable',             bg:'#3B6EF8' },
  { photo:'photos/p11.jpg', label:'Soft moment',        sub:'The quiet kind',             bg:'#FF5C1A' },
  { photo:'photos/p12.jpg', label:'Big laugh',          sub:'Could hear it through the screen', bg:'#AAEE44' },
  { photo:'photos/p13.jpg', label:'Green sweater',      sub:'Ottawa winter look',         bg:'#FF3CAC' },
  { photo:'photos/p14.jpg', label:'Late night',         sub:'Pearl bracelet, always',     bg:'#FFD600' },
  { photo:'photos/p18.jpg', label:'Gas station',        sub:'Sunglasses on head, always', bg:'#00C9B1' },
  { photo:'photos/p19.jpg', label:'Dinner out',         sub:'That laugh mid-bite',        bg:'#FF5C1A' },
